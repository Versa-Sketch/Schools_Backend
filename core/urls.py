...
urlpatterns = [
    ...
    path('sections/<uuid:section_id>/students/', views.section_students_view, name='section-students'),
    path('students/<uuid:student_id>/', views.student_detail_view, name='student-detail'),
