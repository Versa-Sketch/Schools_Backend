"""
Django settings for schools_backend project.
...
SECRET_KEY = 'django-insecure-io26ghb+331r%f!1v5wz9v)fs&(-vq%3+(5vy3puif!qa#e)bi'
...
ROOT_URLCONF = 'schools_backend.urls'
...
WSGI_APPLICATION = 'schools_backend.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('MYSQL_URL', f"sqlite:///{BASE_DIR / 'db.sqlite3'}"),
        conn_max_age=600
    )
}
